...
#Customized Class for creating Retailer, and Superuser accounts.
...
#Class to define table for Retailers.
class Retailer(AbstractBaseUser, PermissionsMixin):    
    ...
    latitude = models.DecimalField(blank=True, null=True, 
        ...
        DecimalValidator (max_digits=10, decimal_places=6)], 
        max_digits=10, decimal_places=6, 
        help_text="Kindly input the WGS84 latitude and, "
        "restrict the values to a maximum of six decimal places."
        "<br/> Unless you intend to change your location, "
        "you can skip this section in the profile page.")
    longitude = models.DecimalField(blank=True, null=True, 
        validators=[MinValueValidator(-180.0), MaxValueValidator(180.0), 
        DecimalValidator (max_digits=10, decimal_places=6)], 
        max_digits=10, decimal_places=6, 
        help_text="Kindly input the WGS84 longitude and, "
        "restrict the values to a maximum of six decimal places."
        "<br/> Unless you intend to change your location, "
        "you can skip this section in the profile page.")
    ...
    #Products
    pms_rate = models.DecimalField(decimal_places=2, max_digits=6, 
        verbose_name='Petrol: ₦/litre', default=0)
    pms_stock = models.BooleanField(verbose_name='Petrol in stock?', 
        default=False)
    ago_rate = models.DecimalField(decimal_places=2, max_digits=6, 
        verbose_name='Diesel: ₦/litre', default=0)
    ago_stock = models.BooleanField(verbose_name='Diesel in stock?', 
        default=False)
    dpk_rate = models.DecimalField(decimal_places=2, max_digits=6, 
        verbose_name='Kerosene: ₦/litre', default=0)
    dpk_stock = models.BooleanField(verbose_name='Kerosene in stock?', 
        default=False)
    lpg_rate = models.DecimalField(decimal_places=2, max_digits=6, 
        verbose_name='Cooking Gas: ₦/kg', default=0)
    lpg_stock = models.BooleanField(verbose_name='Cooking Gas in stock?', 
        default=False)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.longitude and self.latitude:
            self.coordinates = Point(float(self.longitude), float(self.latitude), srid=4326)
        else:
